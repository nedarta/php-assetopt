 ...
 *
 * This is a vendored copy of Andreas Gohr's splitbrain/php-jsstrip, which is
 * a port of Nick Galbreath's python tool jsstrip.py. Both are released under
 * the BSD license. Original code:
 *
 * @link https://github.com/splitbrain/php-jsstrip
...
class JsStrip
{
     ...
     * @return string
     * @throws JsStripException if parsing fails
     */
    ...
    protected function fatal($msg)
    {
        ...
        $msg = "$msg on line {$this->line}: '{$before}\u{25CE}{$after}'";
        throw new JsStripException($msg);
    }
}
